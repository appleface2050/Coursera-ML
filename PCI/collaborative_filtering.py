...
critics = {'Lisa': {'Lady in the Water': 2.5, 'Snakes on a Plane': 3.5,
           ...
           'Shang': {'Snakes on a Plane': 1.5, 'You, Me and Dupree': 1.0}
           }
...
if __name__ == '__main__':
    # print(sim_pearson(critics, 'Toby', 'Shang'))
    # print(topMatches(critics, 'Shang'))
    # print(getRecommendations(critics, 'Shang'))
    movies = transformPrefs(critics)
    print (movies)
    print(topMatches(movies, 'Lady in the Water'))
    # print(getRecommendations(movies, "Lady in the Water"))  #为物品推荐人。。。

    itemsim = calculateSimilarItems(critics)
    print(itemsim)
    print(itemsim.get("Lady in the Water"))                  #给物品推荐相邻的物品
    print(getRecommendedItems(critics, itemsim, 'Shang'))     #给用户进行推荐物品
